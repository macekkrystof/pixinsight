...
Jako malý bonus ukážu ještě skript pro zvýraznění tmavých mlhovin. Najdete ho v Script → Utilities → DarkStructureEnhance.
...
Dostáváme se do finále. V příštím díle už probereme uložení/export obrázku a v bonusovém díle odstranění šumu pomocí NoiseXterminator.
