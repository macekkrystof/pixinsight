...
> **Poznámka pro mono kamery s více filtry (LRGB, Ha, OIII…):**  
> Pokud snímáte přes více filtrů, postup je totožný – pouze přidáváte flaty pro každý filtr zvlášť. Pokud se liší délka expozice pro různé filtry (např. kratší pro L, delší pro narrowband), přidáváte i darky odpovídající jednotlivým expozičním časům. WBPP automaticky správně spáruje kalibrační snímky podle filtru a expozice.
