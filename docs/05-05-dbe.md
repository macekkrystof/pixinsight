...
Teď konečně otevřeme složený snímek z minulého dílu. Klikněte na File → Open, najděte adresář s výsledky WBPP a otevřete soubor *masterLight…_integration_drizzle_autocrop.xisf*, jak jsme si řekli na konci [předchozího dílu](./03-03-wbpp.md).
